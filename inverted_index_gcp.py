...
def get_bucket(bucket_name):
    """
    Gets a GCP storage bucket by name.
    :param bucket_name: Name of the GCP storage bucket.
...
class InvertedIndex:  
    ...
    def read_posting_list(self, w, base_dir=".", bucket_name=None):
        """
        Reads the posting list for a specific word 'w' from the binary files.
        Assumes the binary files (.bin) are present in the 'base_dir' or current directory.
        """
        #
